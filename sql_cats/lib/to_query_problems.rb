...
def price_like_shiny_mouse
  ...
  # DO NOT USE A SUBQUERY
  execute(<<-SQL) 
  SELECT DISTINCT notshinytoys.name, notshinytoys.price 
  FROM toys as notshinytoys
  JOIN toys as shinytoys ON shinytoys.price = notshinytoys.price
  WHERE notshinytoys.name != 'Shiny Mouse' AND shinytoys.name = 'Shiny Mouse'
  ORDER BY notshinytoys.name ASC
  SQL
end
...
def price_like_shiny_mouse_sub
  ...
  FROM toys
  WHERE toys.name != 'Shiny Mouse' AND
  toys.price IN (SELECT toys.price FROM toys WHERE toys.name = 'Shiny Mouse')
  ORDER BY toys.name ASC 
  SQL
end
...
def just_like_orange
  ...
  # DO NOT USE A SUBQUERY
  execute(<<-SQL)
  SELECT orange_breed.name, orange_breed.breed
  FROM cats AS orange_breed
  JOIN cats AS orange_named ON orange_breed.breed = orange_named.breed
  WHERE orange_named.name = 'Orange' AND orange_breed.name != 'Orange'
  ORDER BY orange_breed.name ASC
  SQL
end
...
def just_like_orange_sub
  ...
  FROM cats 
  WHERE cats.breed = (SELECT cats.breed FROM cats WHERE cats.name = 'Orange')
